 ...
 * https://github.com/PineappleDevelopmentGroup/Pineapple/pulls
 ...
 * <p>
 * Copyright 2024 PineappleDevelopmentGroup
 * <p>
...
/*
 * STATE CHANGES :
 * Edited to use java.util.Optional instead of sh.miles.pineapple.function.Option
 * Added getOrThrow method
 */

package ovh.paulem.arcana.registry;
...
public interface Registry<T extends RegistryKey<K>, K> {
    ...
    /**
     * Fetches an entry from the registry using the specified key or throws an exception if no entry exists.
     *
     * @param key the key to fetch the entry from the registry
     * @return the entry corresponding to the specified key
     * @throws IllegalArgumentException if no entry exists for the specified key
     */
    @NotNull
    T getOrThrow(@NotNull final K key);
