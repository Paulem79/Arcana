...
public class WriteableRegistry<T extends RegistryKey<K>, K> extends AbstractRegistry<T, K> {
    ...
    /**
     * Creates a new, empty writeable registry backed by the map produced by the given supplier.
     *
    ...
    /**
     * Creates a new, empty writeable registry backed by a {@link HashMap}.
     */
