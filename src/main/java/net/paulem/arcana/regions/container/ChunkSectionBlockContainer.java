...
import net.paulem.arcana.regions.container.blocks.DynamicSectionContainer;
...
public class ChunkSectionBlockContainer<S extends Tracked<K>, K extends WorldKey> implements SubContainerHolderAccessor<S, K> {
    ...
    /**
     * Creates a new, empty {@code ChunkSectionBlockContainer} for the given parent chunk container and section index.
     *
     * @param parent the chunk container this section belongs to
     * @param sectionY the vertical index of this section within the chunk
     * @param <S> the type of the tracked entities being managed
     * @param <K> the type of the key associated with the tracked entities
     * @return a new {@code ChunkSectionBlockContainer} instance
     */
    ...
    /**
     * Retrieves the tracked object at the given coordinates, relative to this section.
     *
     * @param x the x coordinate
     * @param y the y coordinate
     * @param z the z coordinate
     * @return the tracked object at the given coordinates, or {@code null} if none is stored there
     */
    @Override
    ...
    /**
     * Stores a tracked object at the given coordinates, relative to this section.
     *
     * @param x the x coordinate
     * @param y the y coordinate
     * @param z the z coordinate
    ...
    /**
     * Removes the tracked object at the given coordinates, relative to this section, and notifies
     * the parent chunk container to remove this section if it has become empty as a result.
     *
     * @param x the x coordinate
     * @param y the y coordinate
     * @param z the z coordinate
    ...
    /**
     * Removes every holder stored in this section.
     */
    public void clear() {
    ...
    /**
     * @return a collection of all holders currently stored in this section
     */
    @Override
